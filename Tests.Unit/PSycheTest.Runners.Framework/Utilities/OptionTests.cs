...
namespace Tests.Unit.PSycheTest.Runners.Framework.Utilities
{
	public class OptionTests
	{
		...
		[Fact]
		public void Test_None_GetHashCode()
		{
			// Arrange.
			var none = Option<string>.None();

			// Act.
			int hashCode = none.GetHashCode();

			// Assert.
			Assert.Equal(Option<string>.None().GetHashCode(), hashCode);
		}

		[Fact]
		public void Test_Some_Self_Equality()
		{
			// Arrange.
			var some = Option<string>.Some("some");

			// Act.
			bool equal = some.Equals(some);
		...
		[Fact]
		public void Test_Some_Null_Inequality()
		{
			// Arrange.
			var some = Option<string>.Some("test");

			// Act.
			bool equal = some.Equals(null);
		...
		[Fact]
		public void Test_Some_GetHashCode()
		{
			// Arrange.
			var some = Option<string>.Some("test");

			// Act.
			int hashCode = some.GetHashCode();
